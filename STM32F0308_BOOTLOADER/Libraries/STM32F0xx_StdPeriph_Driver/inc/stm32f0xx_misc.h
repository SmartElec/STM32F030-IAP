...
typedef struct
{
  ...
  uint8_t NVIC_IRQChannelPriority;     /*!< 指定的优先级指定的IRQ通道
                                            在NVIC_IRQChannel。这个参数可以是一个值
                                            0和3之间。  */

  FunctionalState NVIC_IRQChannelCmd;  /*!< 指定是否在NVIC_IRQChannel定义的IRQ通道
                                            将被启用或禁用。
                                            此参数可以设置要么ENABLE或DISABLE */   
} NVIC_InitTypeDef;
